...
public class Markov {
    ...
    /**
     * Gives the frequency count of a suffix character; that is, the number of
     * times the specified suffix follows the substring in a text.
     *
     ...
     * substring. Character possibilities are added to an ArrayList (duplicates
     * allowed), and a random number from 0 to the last index in the ArrayList
     * is picked. Since more common suffixes occupy more indices in the
     * ArrayList, the probability of getting a more common suffix is greater
     * than the probability of getting a less common suffix.
     *
